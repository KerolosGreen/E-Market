      ...
      <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
         <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
               ...
               <li>
                  <a href="{{route('admin.orders')}}" class="active flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <main>
              ...
              <div class="w-full mb-1">
                  <div class="mb-4">
                      ...
                      <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Current Orders</h1>
                  </div>
                  <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                      <div class="flex items-center mb-4 sm:mb-0">
                              ...
                              <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                                  <input onkeyup='searchTable()' type="text" name="email" id="orders-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search for Order By ID">
                              </div>
          ...
          <div class="flex flex-col">
              <div class="overflow-x-auto">
                  <div class="inline-block min-w-full relative max-w-full w-full align-middle">
                      <div class=" shadow">
                          <table class="divide-y divide-gray-200 table-fixed dark:divide-gray-600" style="width: 100%;" id="orders-table">
                              ...
                              <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                @foreach($orders as $order)
                                  ...
                                  <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                      ...
                                      <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$order->user->firstname.' '.$order->user->lastname}}<br><span class="text-xs text-gray-400">User Id {{$order->user->id}}</span></td>
                                      <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$order->payment==null?'Cash OD':'Visa - '.substr($order->payment->cc,-4)}}</td>
                                      <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$order->user->phone_number}}</td>
                                      <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$order->address->address}}</td>
                                      <td class="p-4 text-base font-medium text-green-600 whitespace-nowrap dark:text-green-400">Delivered</td>
...
function searchTable() {
    ...
    input = document.getElementById("orders-search");
